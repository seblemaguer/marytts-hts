 ...
 */
public class HTSLabelGenerator implements MaryModule
{
	...
	public void startup()
    {
		...
		logger.info("Module started marytts.hts.labels.HTSLabelGenerator (" + getInputType() +
                    " => " + getOutputType() + ").");
        ...
        throws Exception
    {
        ...
        transformer.transform(new DOMSource(d.getDocument()), new StreamResult(writer));
